**Project Idea: MindGarden – Positive Habit Growth With Virtual Plant**

**Problem:** - People struggle to build and maintain positive habits. Traditional habit trackers feel boring, leading to low consistency and motivation.

**Solution:**
A gamified habit-building web application where each completed habit helps a virtual plant grow.
Users create habits, track daily progress, maintain streaks, and watch their plant evolve from a seed to a flowering plant. Missing habits slows or reverses growth, encouraging consistency.
